...
def getEquipment():
        ...
        equipment['CulturePlate']=create_container_instance("CulturePlate24",slot="D2",grid=(4,6),spacing=(19.304,19.304),diameter=16.26,depth=18)
        ...
        equipment['TubBlood']=create_container_instance("TubBlood",slot="C1",grid=(8,1),spacing=(9.02,9.02),diameter=0,depth=55)
        equipment['TubMedia']=create_container_instance("TubMedia",slot="C1",grid=(8,1),spacing=(9.02,9.02),diameter=0,depth=55)
        equipment['TubSybr']=create_container_instance("TubSybr",slot="C1",grid=(8,1),spacing=(9.02,9.02),diameter=0,depth=55)
